...
export default class EventManager {
    ...
    public static EvtSaveClientSocket = "evt_save_client_socket";
    public static EvtRemoveClientSocket = "evt_remove_client_socket";
    public static EvtResaveMessage = "evt_resave_massage";
